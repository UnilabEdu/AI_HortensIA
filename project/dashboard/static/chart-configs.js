...
// console.log(leaderboardColors)
    ...
    streakGoalChartConfig.data.labels = ['აქტიურობის დღეები', 'შემდეგ მიზნამდე']
    const weeklyGoalChartConfig = clone(doughnutChartConfig)
    weeklyGoalChartConfig.data.labels = ['ბოლო 7 დღეს შევსებული ბარათები', 'შემდეგ მიზნამდე']
    const rankupGoalChartConfig = clone(doughnutChartConfig)
    rankupGoalChartConfig.data.labels = ['ამდენი ბარათით ასწრებ წინა მომხმარებელს', 'გადასასწრებად დარჩა']
